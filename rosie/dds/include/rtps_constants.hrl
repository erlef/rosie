...
-define(GUID_UNKNOWN,#guId{prefix= ?GUIDPREFIX_UNKNOWN,entityId= ?ENTITYID_UNKNOWN}).
...
-define(ENTITYID_SEDP_BUILTIN_TOPICS_ANNOUNCER ,        #entityId{key = <<00,00,02>> ,kind = 16#c2}).
-define(ENTITYID_SEDP_BUILTIN_TOPICS_DETECTOR ,	        #entityId{key = <<00,00,02>> ,kind = 16#c7}).
-define(ENTITYID_SEDP_BUILTIN_PUBLICATIONS_ANNOUNCER ,	#entityId{key = <<00,00,03>> ,kind = 16#c2}).
-define(ENTITYID_SEDP_BUILTIN_PUBLICATIONS_DETECTOR ,	#entityId{key = <<00,00,03>> ,kind = 16#c7}).
-define(ENTITYID_SEDP_BUILTIN_SUBSCRIPTIONS_ANNOUNCER , #entityId{key = <<00,00,04>> ,kind = 16#c2}).
-define(ENTITYID_SEDP_BUILTIN_SUBSCRIPTIONS_DETECTOR ,	#entityId{key = <<00,00,04>> ,kind = 16#c7}).
-define(ENTITYID_SPDP_BUILTIN_PARTICIPANT_WRITER ,	#entityId{key = <<00,01,00>> ,kind = 16#c2}).
-define(ENTITYID_SPDP_BUILTIN_PARTICIPANT_READER ,	#entityId{key = <<00,01,00>> ,kind = 16#c7}).
-define(ENTITYID_P2P_BUILTIN_PARTICIPANT_MESSAGE_WRITER,#entityId{key = <<00,02,00>> ,kind = 16#c2}).
-define(ENTITYID_P2P_BUILTIN_PARTICIPANT_MESSAGE_READER,#entityId{key = <<00,02,00>> ,kind = 16#c7}).
...
-define(D2,1).
-define(D3,11).
-define(SPDP_WELL_KNOWN_MULTICAST_PORT(DomainId), 
        ?PB + ?DG * DomainId + ?D0).
-define(SPDP_WELL_KNOWN_UNICAST_PORT(DomainId,ParticipantId), 
        ?PB + ?DG * DomainId + ?D1 + ?PG * ParticipantId).
-define(DEFAULT_MULTICAST_IP, {239,255,0,1} ). 
-define(DEFAULT_MULTICAST_LOCATOR(DomainID), 
        #locator{
                kind = ?LOCATOR_KIND_UDPv4,
                ip = ?DEFAULT_MULTICAST_IP,
                port = ?PB + ?D0 + (?DG * DomainID) % DomainId should be 0 for iteroperability
        }).
...
-define(PARTICIPANT_MESSAGE_DATA_KIND_AUTOMATIC_LIVELINESS_UPDATE, <<00, 00, 00, 01>>).
