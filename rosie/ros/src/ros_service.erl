...
init(#state{service_interface = Service, 
        ...
        SpawnRequest = #user_topic{name = SpawnRequest_name,type_name = SpawnRequest_type, qos_profile=QoSProfile},
        ...
        SpawnReply = #user_topic{name = SpawnReply_name,type_name = SpawnReply_type, qos_profile=QoSProfile},
...
handle_cast({send_response, {Client_ID, RequestNumber,Response}}, #state{dds_data_writer = DW,service_interface = Service} = S) -> 
...
handle_cast({on_data_available, { Reader, ChangeKey}},
        ...
        case Response of
                ros_service_noreply -> ok;
                _ -> ros_service:send_response({?MODULE,Service}, {Client_ID, RequestNumber, Response})
        end,
        {noreply,S};
